...
public static class AllNationData
{
    ...
    public static void Init()
    {
        ...
        // early age
        AddNation(new NationData("(EA) Arcoscephale", 5, 0.0f, Age.EARLY, Terrain.MOUNTAINS, new Terrain[] { Terrain.PLAINS, Terrain.PLAINS, Terrain.PLAINS }));
        ...
        AddNation(new NationData("(MA) Sceleria", 45, 0.0f, Age.MIDDLE, Terrain.PLAINS, new Terrain[] { Terrain.PLAINS, Terrain.PLAINS | Terrain.SMALLPROV, Terrain.HIGHLAND }));
