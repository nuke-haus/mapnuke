...
public static class AllNationData
{
    ...
    public static void Init()
    {
        ...
        AddNation(new NationData("(EA) Fomoria", 19, 0.1f, Age.EARLY, Terrain.PLAINS, new Terrain[] { Terrain.FOREST, Terrain.PLAINS }));
        AddNation(new NationData("(EA) Vanheim", 20, 0.1f, Age.EARLY, Terrain.HIGHLAND, new Terrain[] { Terrain.FOREST, Terrain.HIGHLAND, Terrain.HIGHLAND }));
        ...
        AddNation(new NationData("(EA) Berytos", 30, 0.1f, Age.EARLY, Terrain.PLAINS, new Terrain[] { Terrain.WASTE, Terrain.PLAINS, Terrain.PLAINS }));
        ...
        AddNation(new NationData("(MA) Machaka", 53, 0.0f, Age.MIDDLE, Terrain.FOREST, new Terrain[] { Terrain.FOREST, Terrain.FOREST, Terrain.CAVE }));
        ...
        AddNation(new NationData("(MA) Vanheim", 60, 0.1f, Age.MIDDLE, Terrain.HIGHLAND, new Terrain[] { Terrain.FOREST, Terrain.PLAINS, Terrain.HIGHLAND }));
        ...
        AddNation(new NationData("(LA) Marignon", 85, 0.1f, Age.LATE, Terrain.HIGHLAND, new Terrain[] { Terrain.HIGHLAND | Terrain.LARGEPROV, Terrain.PLAINS, Terrain.PLAINS }));
