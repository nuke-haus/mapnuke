...
public static class AllNationData
{
    ...
    public static void Init()
    {
        ...
        // early age
        AddNation(new NationData("(EA) Arcoscephale", 5, 0.0f, Age.EARLY, Terrain.MOUNTAINS, new Terrain[] { Terrain.PLAINS, Terrain.PLAINS }));
        AddNation(new NationData("(EA) Ermor", 6, 0.0f, Age.EARLY, Terrain.PLAINS, new Terrain[] { Terrain.PLAINS, Terrain.FOREST }));
        AddNation(new NationData("(EA) Ulm", 7, 0.0f, Age.EARLY, Terrain.FOREST, new Terrain[] { Terrain.FOREST, Terrain.HIGHLAND }));
        AddNation(new NationData("(EA) Marverni", 8, 0.0f, Age.EARLY, Terrain.FOREST, new Terrain[] { Terrain.PLAINS, Terrain.FOREST }));
        ...
        AddNation(new NationData("(EA) T'ien Chi", 10, 0.0f, Age.EARLY, Terrain.PLAINS, new Terrain[] { Terrain.FOREST, Terrain.PLAINS }));
        ...
        AddNation(new NationData("(EA) Mictlan", 12, 0.0f, Age.EARLY, Terrain.PLAINS, new Terrain[] { Terrain.FOREST, Terrain.PLAINS }));
        AddNation(new NationData("(EA) Abysia", 13, 0.0f, Age.EARLY, Terrain.CAVE, new Terrain[] { Terrain.WASTE, Terrain.CAVE, Terrain.PLAINS }));
        AddNation(new NationData("(EA) Caelum", 14, 0.0f, Age.EARLY, Terrain.MOUNTAINS, new Terrain[] { Terrain.MOUNTAINS, Terrain.PLAINS }));
        AddNation(new NationData("(EA) C'tis", 15, 0.0f, Age.EARLY, Terrain.SWAMP, new Terrain[] { Terrain.WASTE, Terrain.SWAMP, Terrain.PLAINS }));
        AddNation(new NationData("(EA) Pangaea", 16, 0.0f, Age.EARLY, Terrain.FOREST, new Terrain[] { Terrain.FOREST | Terrain.SMALLPROV, Terrain.FOREST | Terrain.SMALLPROV, Terrain.FOREST }));
        AddNation(new NationData("(EA) Agartha", 17, 0.0f, Age.EARLY, Terrain.CAVE, new Terrain[] { Terrain.CAVE, Terrain.CAVE, Terrain.PLAINS }));
        AddNation(new NationData("(EA) Tir Na N'og", 18, 0.0f, Age.EARLY, Terrain.HIGHLAND, new Terrain[] { Terrain.SWAMP, Terrain.HIGHLAND, Terrain.PLAINS }));
        AddNation(new NationData("(EA) Fomoria", 19, 0.0f, Age.EARLY, Terrain.PLAINS, new Terrain[] { Terrain.FOREST, Terrain.PLAINS }));
        AddNation(new NationData("(EA) Vanheim", 20, 0.0f, Age.EARLY, Terrain.CAVE, new Terrain[] { Terrain.FOREST | Terrain.SMALLPROV }));
        AddNation(new NationData("(EA) Helheim", 21, 0.0f, Age.EARLY, Terrain.MOUNTAINS, new Terrain[] { Terrain.CAVE, Terrain.HIGHLAND, Terrain.PLAINS }));
        ...
        AddNation(new NationData("(EA) Rus", 24, 0.0f, Age.EARLY, Terrain.FOREST, new Terrain[] { Terrain.FOREST, Terrain.CAVE, Terrain.PLAINS }));
        ...
        AddNation(new NationData("(EA) Yomi", 27, 0.0f, Age.EARLY, Terrain.MOUNTAINS, new Terrain[] { Terrain.MOUNTAINS, Terrain.PLAINS }));
        AddNation(new NationData("(EA) Hinnom", 28, 0.0f, Age.EARLY, Terrain.WASTE, new Terrain[] { Terrain.WASTE, Terrain.WASTE | Terrain.LARGEPROV, Terrain.PLAINS }));
        AddNation(new NationData("(EA) Ur", 29, 0.1f, Age.EARLY, Terrain.PLAINS, new Terrain[] { Terrain.SWAMP, Terrain.PLAINS, Terrain.PLAINS }));
        AddNation(new NationData("(EA) Berytos", 30, 0.0f, Age.EARLY, Terrain.PLAINS, new Terrain[] { Terrain.WASTE, Terrain.WASTE | Terrain.LARGEPROV, Terrain.PLAINS }));
        ...
        AddNation(new NationData("(EA) Mekone", 32, 0.0f, Age.EARLY, Terrain.MOUNTAINS, new Terrain[] { Terrain.MOUNTAINS, Terrain.PLAINS, Terrain.PLAINS }));
        ...
        AddNation(new NationData("(EA) R'lyeh", 37, 1.0f, Age.EARLY, Terrain.DEEPSEA | Terrain.SEA, new Terrain[] { Terrain.DEEPSEA | Terrain.SEA, Terrain.DEEPSEA | Terrain.SEA, Terrain.HIGHLAND | Terrain.SEA, Terrain.SEA, Terrain.SEA }));
        AddNation(new NationData("(EA) Pelagia", 38, 1.0f, Age.EARLY, Terrain.DEEPSEA | Terrain.SEA, new Terrain[] { Terrain.DEEPSEA | Terrain.SEA, Terrain.FARM | Terrain.SEA, Terrain.SEA, Terrain.SEA, Terrain.SEA }));
        ...
        AddNation(new NationData("(EA) Therodos", 40, 1.0f, Age.EARLY, Terrain.SEA | Terrain.HIGHLAND, new Terrain[] { Terrain.SEA | Terrain.HIGHLAND, Terrain.SEA | Terrain.HIGHLAND, Terrain.SEA, Terrain.SEA, Terrain.SEA }));

        // middle age
        AddNation(new NationData("(MA) Arcoscephale", 43, 0.0f, Age.MIDDLE, Terrain.MOUNTAINS, new Terrain[] { Terrain.MOUNTAINS, Terrain.PLAINS, Terrain.PLAINS }));
        AddNation(new NationData("(MA) Ermor", 44, 0.0f, Age.MIDDLE, Terrain.PLAINS, new Terrain[] { Terrain.PLAINS, Terrain.PLAINS | Terrain.SMALLPROV }));
        AddNation(new NationData("(MA) Sceleria", 45, 0.0f, Age.MIDDLE, Terrain.PLAINS, new Terrain[] { Terrain.PLAINS, Terrain.PLAINS | Terrain.SMALLPROV }));
        AddNation(new NationData("(MA) Pythium", 46, 0.0f, Age.MIDDLE, Terrain.SWAMP, new Terrain[] { Terrain.PLAINS, Terrain.PLAINS }));
        ...
        AddNation(new NationData("(MA) Ulm", 49, 0.0f, Age.MIDDLE, Terrain.HIGHLAND, new Terrain[] { Terrain.HIGHLAND, Terrain.FOREST, Terrain.PLAINS }));
        ...
        AddNation(new NationData("(MA) Machaka", 53, 0.0f, Age.MIDDLE, Terrain.CAVE, new Terrain[] { Terrain.FOREST, Terrain.FOREST, Terrain.PLAINS }));
        AddNation(new NationData("(MA) Agartha", 54, 0.0f, Age.MIDDLE, Terrain.CAVE, new Terrain[] { Terrain.CAVE, Terrain.CAVE, Terrain.MOUNTAINS }));
        AddNation(new NationData("(MA) Abysia", 55, 0.0f, Age.MIDDLE, Terrain.CAVE, new Terrain[] { Terrain.WASTE, Terrain.PLAINS, Terrain.PLAINS }));
        AddNation(new NationData("(MA) Caelum", 56, 0.0f, Age.MIDDLE, Terrain.MOUNTAINS, new Terrain[] { Terrain.MOUNTAINS, Terrain.PLAINS, Terrain.PLAINS }));
        ...
        AddNation(new NationData("(MA) Pangaea", 58, 0.0f, Age.MIDDLE, Terrain.FOREST, new Terrain[] { Terrain.FOREST | Terrain.SMALLPROV, Terrain.FOREST | Terrain.SMALLPROV, Terrain.FOREST}));
        ...
        AddNation(new NationData("(MA) Vanheim", 60, 0.0f, Age.MIDDLE, Terrain.CAVE, new Terrain[] { Terrain.FOREST, Terrain.PLAINS, Terrain.SEA }));
        ...
        AddNation(new NationData("(MA) Shinuyama", 64, 0.0f, Age.MIDDLE, Terrain.MOUNTAINS, new Terrain[] { Terrain.MOUNTAINS, Terrain.PLAINS, Terrain.PLAINS }));
        ...
        AddNation(new NationData("(MA) Uruk", 66, 0.1f, Age.MIDDLE, Terrain.PLAINS, new Terrain[] { Terrain.PLAINS, Terrain.PLAINS, Terrain.SWAMP | Terrain.LARGEPROV }));
        ...
        AddNation(new NationData("(MA) Phlegra", 69, 0.0f, Age.MIDDLE, Terrain.MOUNTAINS, new Terrain[] { Terrain.MOUNTAINS, Terrain.PLAINS, Terrain.PLAINS }));
        ...
        AddNation(new NationData("(MA) Oceania", 76, 1.0f, Age.MIDDLE, Terrain.SEA | Terrain.FOREST, new Terrain[] { Terrain.SEA | Terrain.FOREST, Terrain.SEA | Terrain.FOREST, Terrain.SEA | Terrain.FOREST, Terrain.SEA | Terrain.FARM, Terrain.SEA }));
        ...
        AddNation(new NationData("(LA) Pythium", 81, 0.0f, Age.LATE, Terrain.SWAMP, new Terrain[] { Terrain.PLAINS, Terrain.PLAINS }));
        AddNation(new NationData("(LA) Lemuria", 82, 0.0f, Age.LATE, Terrain.PLAINS, new Terrain[] { Terrain.PLAINS, Terrain.PLAINS | Terrain.SMALLPROV }));
        ...
        AddNation(new NationData("(LA) Marignon", 85, 0.0f, Age.LATE, Terrain.PLAINS, new Terrain[] { Terrain.HIGHLAND | Terrain.LARGEPROV, Terrain.PLAINS, Terrain.PLAINS }));
        ...
        AddNation(new NationData("(LA) Abysia", 91, 0.0f, Age.LATE, Terrain.CAVE, new Terrain[] { Terrain.WASTE, Terrain.PLAINS, Terrain.PLAINS }));
        AddNation(new NationData("(LA) Caelum", 92, 0.0f, Age.LATE, Terrain.MOUNTAINS, new Terrain[] { Terrain.MOUNTAINS, Terrain.PLAINS, Terrain.PLAINS }));
        AddNation(new NationData("(LA) C'tis", 93, 0.0f, Age.LATE, Terrain.SWAMP, new Terrain[] { Terrain.WASTE | Terrain.LARGEPROV, Terrain.WASTE | Terrain.LARGEPROV, Terrain.PLAINS }));
        ...
        AddNation(new NationData("(LA) Midgard", 95, 0.0f, Age.LATE, Terrain.HIGHLAND, new Terrain[] { Terrain.FOREST, Terrain.FOREST, Terrain.SEA }));
        ...
        AddNation(new NationData("(LA) Gath", 99, 0.0f, Age.LATE, Terrain.PLAINS, new Terrain[] { Terrain.PLAINS, Terrain.PLAINS }));
        AddNation(new NationData("(LA) Ragha", 100, 0.0f, Age.LATE, Terrain.PLAINS, new Terrain[] { Terrain.MOUNTAINS, Terrain.PLAINS, Terrain.PLAINS }));
