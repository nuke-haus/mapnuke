...
public static class AllNationData
{
    ...
    public static void Init()
    {
        ...
        // generic starts
        // AddNation(new NationData("Coastal Nation", -1, 0.3f, Age.ALL, Terrain.PLAINS, new Terrain[] { Terrain.PLAINS, Terrain.FOREST, Terrain.SEA })); // We need to remove this since Dom5 does not appropriately assign nations to this start.
        ...
        AddNation(new NationData("(EA) Fomoria", 19, 0.3f, Age.EARLY, Terrain.HIGHLAND, new Terrain[] { Terrain.FOREST, Terrain.PLAINS, Terrain.PLAINS }));
        ...
        AddNation(new NationData("(EA) Berytos", 30, 0.2f, Age.EARLY, Terrain.PLAINS, new Terrain[] { Terrain.WASTE | Terrain.LARGEPROV, Terrain.FOREST, Terrain.FOREST, Terrain.PLAINS | Terrain.LARGEPROV, Terrain.SEA }));
